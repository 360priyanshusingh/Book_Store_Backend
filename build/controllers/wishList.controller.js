    ...
    return _regenerator["default"].wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return wishListService.addItem(req.body, req.params.id);
        case 3:
          data = _context.sent;
    ...
    return _regenerator["default"].wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return wishListService.removeItem(req.body, req.params.id);
        case 3:
          data = _context2.sent;
          res.status(data.code).json({
            code: data.code,
...
var deleteWishList = exports.deleteWishList = /*#__PURE__*/function () {
    ...
    return _regenerator["default"].wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _context3.next = 3;
          return wishListService.deleteWishList(req.params.id);
        case 3:
          data = _context3.sent;
          res.status(data.code).json({
            code: data.code,
  ...
  return function deleteWishList(_x5, _x6) {
    ...
    return _regenerator["default"].wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.prev = 0;
          _context4.next = 3;
          return wishListService.deleteItem(req.body, req.params.id);
        case 3:
          data = _context4.sent;
          res.status(data.code).json({
            code: data.code,
    ...
    return _regenerator["default"].wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          _context5.prev = 0;
          _context5.next = 3;
          return wishListService.getWishList(req.body.userId);
        case 3:
          data = _context5.sent;
          res.status(data.code).json({
            code: data.code,
